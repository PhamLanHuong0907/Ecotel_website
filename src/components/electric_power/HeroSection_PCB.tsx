      ...
      <div className="w-full mx-auto px-4 relative z-10 mt-16">
        ...
        >
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold mb-[60px]">
            <span className="gradient-text">Dịch vụ & Giải pháp sạc pin ô tô điện thông minh </span>
          </h1>
        </motion.div>
        ...
        >
          <div className="glass-card p-8 rounded-2xl space-y-4 ">
            ...
            <span className="text-foreground font-medium"> ECOTEL </span> cung cấp <span className="text-foreground font-medium"> giải pháp IoT toàn diện, từ thiết kế mạch in PCB, </span>phát triển phần cứng, phần mềm nhúng, đến xây dựng hệ thống kết nối IoT giúp các doanh nghiệp và nhà máy tự động hóa, giám sát và quản lý thiết bị từ xa.
            </p>
          </div>
        </motion.div>
      </div>
