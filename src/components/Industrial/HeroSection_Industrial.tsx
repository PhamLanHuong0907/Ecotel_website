...
import industrialVideo from "@/assets/industrial_20x.mp4"; 
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold  mb-8 drop-shadow-lg">
           <div className="h-5"/>
           <span className="bg-gradient-to-br from-blue-600 via-cyan-500 to-teal-400 bg-clip-text text-transparent">CÔNG NGHIỆP</span>
            <div className="h-5"/>
          </h1>
