...
import manufacturingHero from "@/assets/ERP&BI.png";
      ...
      <div className="w-full  mx-auto px-4 relative z-10 mt-16">
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold mb-[60px]">
            ...
            <br />
            <span className="gradient-text">Tối ưu hóa vận hành doanh nghiệp</span>
          </h1>
        </motion.div>
        ...
        >
          <div className="glass-card p-8 rounded-2xl space-y-4 ">
            ...
            <p className="text-muted-foreground leading-relaxed text-[19px]">
               Trong kỷ nguyên số, việc áp dụng hệ thống ERP (Enterprise Resource Planning) và BI (Business Intelligence) trở thành yếu tố quyết định giúp doanh nghiệp tối ưu hóa quy trình vận hành, tăng cường khả năng quản lý dữ liệu và ra quyết định chính xác dựa trên thông tin thời gian thực <span className="text-foreground font-medium">ECOTEL</span> mang đến giải pháp <span className="text-foreground font-medium">ERP & BI toàn diện, giúp doanh nghiệp chuẩn hóa quy trình, đồng bộ dữ liệu và nâng cao hiệu suất hoạt động.</span>
            </p>
          </div>
        </motion.div>
      </div>
