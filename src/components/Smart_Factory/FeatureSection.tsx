            ...
            <div className="space-y-4">
              {features.map((feature, index) => (
                <motion.div
                  ...
                  // Lưu ý: Đã xóa các class styling ở đây và chuyển vào thẻ Link bên dưới
                >
                  {/* 2. Bọc nội dung bằng thẻ Link và áp dụng class style vào đây */}
                  <Link 
                    to={feature.path}
                    className="glass-card p-5 rounded-xl flex items-start gap-4 hover-lift group transition-all"
                  >
