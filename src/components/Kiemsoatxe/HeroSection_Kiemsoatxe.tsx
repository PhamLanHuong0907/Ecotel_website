...
import factoryHero from "@/assets/kiemsoatxe.png";
      ...
      <div className="w-full mx-auto px-4 relative z-10 mt-16">
        ...
        >
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold mb-[60px]">
            <span className="gradient-text">Giải pháp đỗ xe thông minh </span>
            <br />
            <span className="gradient-text pt-3">& Kiểm soát xe ra vào</span>
          </h1>
        </motion.div>
        ...
        >
          <div className="glass-card p-8 rounded-2xl space-y-4 ">
            <p className="text-muted-foreground leading-relaxed text-[19px]">
              Với sự phát triển nhanh chóng của đô thị và nhu cầu tối ưu không gian đỗ xe, <span className="text-foreground font-medium"> ECOTEL </span> cung cấp các <span className="text-foreground font-medium">giải pháp đỗ xe tự động & kiểm soát phương tiện hiện đại </span>, giúp nâng cao hiệu suất vận hành, tiết kiệm diện tích và đảm bảo an toàn cho các bãi đỗ xe tại <span className="text-foreground font-medium"> khu đô thị, tòa nhà, trung tâm thương mại, khu công nghiệp.</span>
            </p>
          </div>
        </motion.div>
      </div>
